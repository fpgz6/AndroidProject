...
public class PushActivity extends Fragment {
    ...
    private String _rtmpUrl = "rtmp://192.168.1.106/live";
...
/*
        ...
        _rtmpUrl = intent.getStringExtra("rtmpUrl");
*/
        Intent intent = activity.getIntent();
 ...
 public void onCreate(Bundle savedInstanceState) {
    ...
    public void InitCamera() {
       ...
       // p.setPictureSize(720, 1080);
      //  p.setPreviewSize(720,1080);
    ...
    private final class SurceCallBack  implements SurfaceHolder.Callback {
        ...
        Context context;
/*
        public SurceCallBack(Context context) {
            super(context);
...
*/
    ...
    private View.OnClickListener _switchCameraOnClickedEvent = new View.OnClickListener() {
        ...
        public void onClick(View arg0) {
            Log.d("Left","onclick-start");
            //华为i7前后共用摄像头
            if (Camera.getNumberOfCameras() == 1) {
               Toast.makeText(activity, "没有前置摄像头哦！",Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void InitAll() {
       ...
       //_mSurfaceView=new SurceCallBack(activity);
        _mSurfaceView = (SurfaceView) view.findViewById(R.id.surfaceViewEx);
